...
> **Contexto HCE:** toda salida en **español** (regla del proyecto). Es útil para afinar prompts hacia los subagentes/skills de la HCE y complementa a `entrevistador-procesos` (que puede pedir un *brief de skill*: este optimizador convierte ese brief en el prompt final).
...
- El resultado debe ser inmediatamente usable, en español.
