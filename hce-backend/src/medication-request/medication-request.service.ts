...
export class MedicationRequestService {
  ...
  private readonly VADEMECUM = [
    ...
    {
      code: 'AMX-CLV',
      name: 'Amoxicilina 875 mg + Ácido Clavulánico 125 mg',
      substance: 'Amoxicilina / Ácido Clavulánico',
      category: 'Antibiótico',
    },
    {
      code: 'IBU-400',
    ...
    },
    {
      ...
      substance: 'Ketorolac',
      category: 'Analgésico potente',
    },
    {
      code: 'KT-20',
      name: 'Ketorolac 20 mg (Sublingual)',
      substance: 'Ketorolac',
      category: 'Analgésico potente',
    },
    {
      ...
      substance: 'Cefalexina',
      category: 'Antibiótico',
    },
    {
      code: 'DXM-4',
      name: 'Dexametasona 4 mg',
      substance: 'Dexametasona',
      category: 'Corticoide',
    },
    {
      code: 'DXM-8',
      name: 'Dexametasona 8 mg (Inyectable)',
      substance: 'Dexametasona',
      category: 'Corticoide',
    },
    {
    ...
    {
      code: 'NPR-500',
      name: 'Naproxeno 500 mg',
      substance: 'Naproxeno',
      category: 'Analgésico / Antiinflamatorio',
    },
    {
      code: 'PNC-G',
      name: 'Penicilina G Sódica 1.200.000 UI',
      substance: 'Penicilina',
      category: 'Antibiótico',
    },
    {
      code: 'PNC-V',
      name: 'Penicilina V 500.000 UI',
      substance: 'Penicilina',
      category: 'Antibiótico',
    },
    {
    ...
    {
      code: 'ASP-100',
      name: 'Aspirina 100 mg (Ácido Acetilsalicílico)',
      substance: 'Aspirina',
    ...
    {
      code: 'AML-5',
      name: 'Amlodipina 5 mg',
      substance: 'Amlodipina',
      category: 'Antihipertensivo',
    },
    {
      code: 'ATV-20',
    ...
    {
      code: 'LVT-100',
      name: 'Levotiroxina 100 mcg',
      substance: 'Levotiroxina',
    ...
    },
    {
      ...
      name: 'Diazepam 5 mg',
      substance: 'Diazepam',
      category: 'Ansiolítico / Miorrelajante',
    },
    {
      code: 'SND-50',
      name: 'Sildenafil 50 mg',
      substance: 'Sildenafil',
      category: 'Disfunción eréctil',
    },
    {
      code: 'CHX-012',
      name: 'Clorhexidina Colutorio 0.12%',
      substance: 'Clorhexidina',
      category: 'Antiséptico Bucal',
    },
    {
      code: 'CHX-GEL',
      name: 'Clorhexidina Gel Dental 0.20%',
      substance: 'Clorhexidina',
      category: 'Antiséptico Bucal',
    },
    {
      code: 'FLU-005',
      name: 'Fluoruro de Sodio Colutorio 0.05%',
      substance: 'Fluoruro de Sodio',
      category: 'Preventivo de Caries',
    },
    {
      code: 'FLU-BAR',
      name: 'Fluoruro de Sodio Barniz 5%',
      substance: 'Fluoruro de Sodio',
      category: 'Preventivo de Caries',
    },
    {
      code: 'NYT-100',
      name: 'Nistatina Suspensión Oral 100.000 UI/ml',
      substance: 'Nistatina',
      category: 'Antimicótico Oral',
    },
    {
      code: 'MCZ-GEL',
    ...
    {
      code: 'TRM-PAR',
      name: 'Tramadol 37.5 mg + Paracetamol 325 mg',
      substance: 'Tramadol / Paracetamol',
      category: 'Analgésico Opioide Combinado',
    },
    {
      code: 'MCD-10',
      name: 'Metoclopramida 10 mg',
      substance: 'Metoclopramida',
      category: 'Antiemético',
    },
    {
      code: 'DPH-50',
      name: 'Difenhidramina 50 mg',
      substance: 'Difenhidramina',
    ...
    {
      code: 'BET-KIT',
      name: 'Betametasona Inyectable (Kit Dúo)',
      substance: 'Betametasona',
      category: 'Corticoide',
    },
    {
      code: 'BUP-05',
      name: 'Bupivacaína 0.5% con Epinefrina (Cartuchos)',
      substance: 'Bupivacaína',
      category: 'Anestésico Local Dental',
    },
    {
      code: 'LID-20',
      name: 'Lidocaína 2% con Epinefrina (Cartuchos)',
      substance: 'Lidocaína',
      category: 'Anestésico Local Dental',
    },
    {
      ...
      substance: 'Mepivacaína',
      category: 'Anestésico Local Dental',
    },
    {
      code: 'MCB-8',
      name: 'Mepivacaína 2% con Corbadrina',
      substance: 'Mepivacaína',
      category: 'Anestésico Local Dental',
    },
  ];
  ...
  async searchVademecum(query: string): Promise<any[]> {
    ...
    return this.VADEMECUM.filter(
      (item) =>
        ...
        item.substance.toLowerCase().includes(lower),
    );
  }
  ...
  async runCdsHooks(
    ...
    const parsedAllergies = allergies.map((a) => {
      const display =
        a.payload?.code?.coding?.[0]?.display || a.payload?.code?.text || '';
    ...
    for (const allergy of parsedAllergies) {
      ...
      if (
        allergy.includes('aine') ||
        allergy.includes('nsaid') ||
        allergy.includes('aspirina') ||
        allergy.includes('ibuprofeno')
      ) {
        if (
  ...
  async create(patientId: string, dto: any, tenantId: string): Promise<any> {
    ...
    const medName =
      dto.medicationName || dto.medicationCodeableConcept?.text || '';
    const medCode = dto.medicationCode || '';
    const warnings = await this.runCdsHooks(
      patientId,
      tenantId,
      medName,
      medCode,
      ...
      dosageInstruction: [
        {
          ...
          timing: {
            repeat: {
              frequency: parseInt(dto.frequencyHours) || 8,
              periodUnit: 'h',
            },
          },
          doseAndRate: [
            { doseQuantity: { value: parseFloat(dto.doseValue) || 1 } },
          ],
        },
      ],
      dispenseRequest: {
        expectedSupplyDuration: {
          value: parseInt(dto.durationDays) || 3,
          unit: 'd',
        },
      },
      extension: [
        {
          url: 'http://hospital.gov/fhir/StructureDefinition/cds-warnings',
          valueString: JSON.stringify(warnings),
        },
      ],
    };
    ...
    await this.medicationRequestRepository.update(saved.id, {
  ...
  async findPendingDrafts(tenantId: string): Promise<any[]> {
    ...
    return drafts.map((d) => ({
      ...
      medicationName:
        d.payload?.medicationCodeableConcept?.text || 'Medicamento',
  ...
  async findOne(id: string, tenantId: string): Promise<any> {
    const entity = await this.medicationRequestRepository.findOne({
      where: { id, tenantId },
    });
  ...
  async update(id: string, dto: any, tenantId: string): Promise<any> {
    ...
    if (entity.status === 'active') {
      throw new ForbiddenException(
        'No se puede modificar una receta electrónica ya firmada.',
      );
    }

    const medName =
      dto.medicationName ||
      entity.payload.medicationCodeableConcept?.text ||
      '';
    const medCode =
      dto.medicationCode ||
      entity.payload.medicationCodeableConcept?.coding?.[0]?.code ||
      '';
    const warnings = await this.runCdsHooks(
      entity.patientId,
      tenantId,
  ...
  async sign(
    ...
    if (entity.status === 'active') {
      throw new BadRequestException(
        'Esta receta ya fue firmada anteriormente.',
      );
    }
    ...
    if (!medName) {
      throw new BadRequestException(
        'No se puede firmar una receta sin especificar un medicamento.',
      );
    }
    ...
    entity.payload = {
      ...
      extension: [
        ...
        {
          url: 'http://hospital.gov/fhir/StructureDefinition/prescription-signed-by',
          valueString: userCtx.userName,
        },
        {
          url: 'http://hospital.gov/fhir/StructureDefinition/prescription-signed-at',
          valueDateTime: now.toISOString(),
        },
        {
          url: 'http://hospital.gov/fhir/StructureDefinition/prescription-hash',
          valueString: hash,
        },
        {
          url: 'http://hospital.gov/fhir/StructureDefinition/prescription-qr',
          valueString: qrData,
        },
      ],
    };
